 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define('K_PATH_IMAGES', base_url('assets/image/logo/'));

/**
 * Deafult image logo used be the default Header() method.
 * Please set here your own logo or an empty string to disable it.
 */
define('PDF_HEADER_LOGO', 'agam.png');
 ...
 * Header title.
 */
define('PDF_HEADER_TITLE', 'Dinas Penanaman Modal Pelayanan Terpadu Satu Pintu (DPMPTSP)');

/**
 * Header description string.
 */
define('PDF_HEADER_STRING', "Kabupaten Agam\nwww.atk.dpmptsp.agamkab.go.id");
