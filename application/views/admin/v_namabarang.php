                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-3">
                            <a href="<?= base_url('namabarang/add'); ?>" class="btn btn-outline-primary">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($nama as $u => $value) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <a href="<?= base_url('namabarang/update/' . $value->id_nama); ?>" class="btn btn-outline-info"><i class="fas fa-edit"></i></a>
                                            <button type="button" data-toggle="modal" data-target="#deleteNama<?= $value->id_nama; ?>" class="btn btn-outline-danger"><i class="fas fa-trash-alt"></i></button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
