            ...
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <input name="peminta" type="text" class="form-control form-control-sm" value="<?= $this->session->userdata('id_user'); ?>" hidden>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="keterangan" class="form-control form-control-sm" rows="4"><?= set_value('keterangan'); ?></textarea>
